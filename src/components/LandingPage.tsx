          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 flex flex-col items-center">
              ...
              <ul className="mb-6 text-gray-600 dark:text-gray-300 text-center">
                <li>
                  User can only have{" "}
                  <span className="font-semibold">2 profiles</span>
                </li>
              </ul>
            ...
            {/* Standard Plan */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 flex flex-col items-center border-2 border-indigo-600 dark:border-indigo-400">
              <h3 className="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">
                Standard Plan
              </h3>
              <p className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              ...
              <ul className="mb-6 text-gray-600 dark:text-gray-300 text-center">
                <li>
                  User can only have{" "}
                  <span className="font-semibold">5 profiles</span>
                </li>
              </ul>
              <span className="inline-block px-4 py-2 text-sm font-medium bg-indigo-100 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 rounded">
                Great for families
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 flex flex-col items-center">
              ...
              <ul className="mb-6 text-gray-600 dark:text-gray-300 text-center">
                <li>
                  User can have up to{" "}
                  <span className="font-semibold">10 profiles</span>
                </li>
              </ul>
              <span className="inline-block px-4 py-2 text-sm font-medium bg-indigo-100 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 rounded">
                Perfect for teams & pros
              </span>
            </div>
          </div>
        </div>
